...
// // 1. Font Import (ఇది మిస్ అయ్యింది, ఇప్పుడు యాడ్ చేసాను)
...
//     // మిగతా ఫోటోలు ఉంటే ఇక్కడ యాడ్ చేసుకోవచ్చు
//   ];
...
//   return (
//     // 3. Font Class Application (ఇది ఉంటేనే ఫాంట్ వస్తుంది)
//     <div className={`min-h-screen bg-gray-50 text-gray-800 font-sans ${skFont.className}`}>
...
//                     <span className="text-2xl font-bold text-orange-700 leading-none tracking-wide">
//                         కత్తి రమేష్
//                     </span>
//                     <span className="text-[10px] md:text-xs text-gray-500 font-bold tracking-wider uppercase mt-1 font-sans">
...
//         {isMobileMenuOpen && (
//           <div className="md:hidden bg-white border-b border-gray-200 shadow-xl absolute w-full z-50 font-sans">
//             <div className="px-4 pt-4 pb-6 space-y-3 flex flex-col">
//               <Link href="/" onClick={() => setIsMobileMenuOpen(false)} className="block px-3 py-2 rounded-md text-base font-bold text-gray-700 hover:bg-orange-50 hover:text-orange-600">హోమ్</Link>
//               <Link href="#about" onClick={() => setIsMobileMenuOpen(false)} className="block px-3 py-2 rounded-md text-base font-bold text-gray-700 hover:bg-orange-50 hover:text-orange-600">మన గురించి</Link>
//               <Link href="/manifesto" onClick={() => setIsMobileMenuOpen(false)} className="block px-3 py-2 rounded-md text-base font-bold text-gray-700 hover:bg-orange-50 hover:text-orange-600">పూర్తి మేనిఫెస్టో</Link>
//               <Link href="/posters" onClick={() => setIsMobileMenuOpen(false)} className="block px-3 py-2 rounded-md text-base font-bold text-orange-700 bg-orange-100 border border-orange-200">📥 ప్రచార పోస్టర్లు</Link>
//               <Link href="#contact" onClick={() => setIsMobileMenuOpen(false)} className="block px-3 py-3 rounded-md text-base font-bold text-center text-white bg-orange-600 hover:bg-orange-700 shadow-md">మద్దతు తెలపండి</Link>
//             </div>
//           </div>
//         )}
//       </nav>
...
//               <div className="inline-flex items-center px-3 py-1 rounded-full border border-orange-200 bg-orange-100 text-orange-800 text-sm font-medium mb-4 shadow-sm font-sans">
...
//                 <ul className="space-y-3 text-left font-sans">
...
//                         <p className="text-[10px] font-extrabold text-orange-600 uppercase mb-1 tracking-wider font-sans">మన గుర్తు</p>
//                         <Image src="/symbol.png" width={70} height={70} alt="Scissors Symbol" className="object-contain mx-auto" />
//                         <p className="text-xl font-extrabold text-gray-900 mt-1">కత్తెర</p>
//                     </div>
//                  </div>
...
//                     <p className="text-xs text-gray-500 font-bold uppercase tracking-wider font-sans">స్వతంత్ర సర్పంచ్ అభ్యర్థి</p>
//                     <p className="text-2xl font-bold text-gray-900">కత్తి రమేష్</p>
//                  </div>
//                </div>
//             </div>
//           </div>
...
//         <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
//           <div className="text-center">
//             <h2 className="text-lg text-orange-600 font-bold tracking-wide uppercase font-sans">మా వాగ్దానం</h2>
...
//                   </div>
//                   <div className="ml-6">
//                     <dt className="text-xl leading-6 font-bold text-gray-900">{item.title}</dt>
...
//                <div className="inline-block bg-red-600 text-white text-xs font-bold px-4 py-1.5 rounded-full mb-4 uppercase tracking-widest shadow font-sans">
...
//                 <h2 className="text-orange-600 font-bold tracking-wide uppercase text-sm font-sans">నా ప్రస్థానం</h2>
...
//                                 <h4 className="text-2xl md:text-3xl font-bold text-center mb-2">{photo.text}</h4>
//                                 <p className="text-sm text-gray-400 mt-2 uppercase tracking-widest font-sans">Memory {index + 1} of 2</p>
//                             </div>
//                          </div>
//                     </div>
//                 ))}
...
//                 </h3>
//                 <p className="text-gray-500 text-center mb-8 font-sans">నేను వింటాను.. పరిష్కరిస్తాను.</p>
...
//             <h2 className="text-orange-100 text-2xl md:text-3xl font-bold mb-8">
...
//                     <h3 className="text-5xl md:text-7xl font-extrabold text-orange-600 tracking-wider mt-4 drop-shadow-sm">
//                        కత్తెర
//                     </h3>
//                 </div>
//             </div>
...
//                 </p>
//                 <div className="text-orange-100 text-xl font-medium font-sans">
...
//                         <p className="text-orange-200 text-xs font-bold uppercase tracking-widest mb-1 font-sans">Polling Date</p>
//                         <p className="text-white font-extrabold text-3xl">11-12-2025</p>
//                         <p className="text-orange-200 text-sm mt-1 font-bold font-sans">( గురువారం )</p>
//                     </div>
//                 </div>
//             </div>
//         </div>
...
//               <div className="mb-8">
//                   <span className="text-3xl font-bold text-white">కత్తి రమేష్</span>
//                   <p className="text-gray-500 text-sm mt-1 uppercase tracking-widest font-sans">మాదన్నపేట సర్పంచ్ అభ్యర్థి</p>
//               </div>
              
//               <p className="text-2xl font-bold mb-4 text-yellow-400">ఆదరించి ఆశీర్వదించండి 🙏</p>
...
//                 <a 
//                   href="https://webtsite.vercel.app/" 
//                   target="_blank" 
